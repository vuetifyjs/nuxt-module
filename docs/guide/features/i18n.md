...
You should use [lazy loading](https://i18n.nuxtjs.org/docs/guide/lazy-load-translations), check [Lazy loading configuration](#lazy-loading-configuration) example.
