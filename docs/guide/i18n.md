...
:::tip
NOTE: You need to provide the translations by yourself. The module won't provide them automatically. Yo can include the translations from `vuetify/locale` or add your own ones.
:::
